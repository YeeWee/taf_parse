...
- [x] BECMG 期间取较差值逻辑（能见度取最小、风速取最大、云底高取最低）
- [x] BECMG 期间 NSW 正确处理（保留原有天气作为较差值）
- [x] 有效期结束时刻处理（左闭右开区间，不含结束时刻）
- [x] VRB 风向显示修复
- [x] TEMPO 降雪显示修复
- [x] CB 云显示修复
- [x] 北美报文格式兼容（分数能见度、FM 行过滤）
- [x] 大小写不敏感解析
- [ ] 完整验证逻辑
...
- v0.22.0 (2026-03-31) - 天气趋势修改
- v0.21.0 (2026-03-31) - 有效期结束时刻处理修复（左闭右开区间，不含结束时刻）
- v0.20.0 (2026-03-31) - 修复 NSW 在 BECMG 完成后的正确行为（BECMG 期间保留较差值）
- v0.19.0 (2026-03-31) - VRB 风向显示修复（BECMG 期间风向比较逻辑错误修复）
- v0.18.0 (2026-03-31) - 按时间查询 bug 修复
- v0.17.0 (2026-03-31) - 修复状态列显示
- v0.16.0 (2026-03-18) - BECMG 期间取较差值支持（能见度取最小、风速取最大、云底高取最低）
- v0.15.0 (2026-03-18) - VRB 风向显示修复（BECMG 期间风向比较逻辑错误修复）
- v0.14.0 (2026-03-17) - TEMPO 降雪显示修复（主体天气为空时 TEMPO 降雪正确显示）
- v0.13.0 (2026-03-17) - CB 云显示修复（积雨云/浓积云显示）
- v0.12.0 (2026-03-16) - TAF AMD/COR 格式支持（修订报、更正报）
...
- v0.5.0 (2026-03-15) - 每小时趋势表格：主体与 TEMPO 分开、新增 BECMG/FM 列、多 TEMPO 分行显示
- v0.4.0 (2026-03-14) - TEMPO 主体分开显示、TEMPO 明细表、最坏情况汇总逻辑
- v0.3.0 (2026-03-13) - 完整支持 FM 变化组、英制单位、时区显示
